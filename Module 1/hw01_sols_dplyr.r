...
##calculate case fatality rate for each county and add to data frame
latest<-latest %>% 
...
##find 10 counties with highest case fatality rates
latest<-latest %>% 
...
##calculate case fatality rate and add to data frame
