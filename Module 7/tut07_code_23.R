...
##approach 2
anova(result) ##output doesn't give us needed info, because the predictors are in a bad 
#order. We must put the predictor we want to keep at the beginning and the potential 
#drop predictors at the end.
